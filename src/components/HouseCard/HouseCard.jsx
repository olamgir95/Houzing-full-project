...
import unknownUser from "../../assets/imgs/user.jpg";
import IconButton from "../Generic/IconButton";
import { Area, Bath, Bed, Car, Container, Full, Info, Like, Prices } from '../HouseCard/HouseCard';
        ...
        <div className="style">
          ...
          <div className="image">
            <div className="ownerImg">
              <img
                src={ownerImg ? ownerImg : unknownUser}
                alt="owner"
                className="owner"
              />
            </div>
